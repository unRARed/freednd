# Per https://www.railsagency.com/blog/2020/03/11/how-to-configure-\
#   full-stack-integration-testing-with-selenium-and-ruby-on-rails/
...
Capybara.javascript_driver = ENV.
  fetch('CAPYBARA_JAVASCRIPT_DRIVER', :chrome_headless).to_sym

#must allow this URL if Webdrivers needs to download a binary
WebMock.disable_net_connect!(
  allow: 'chromedriver.storage.googleapis.com', allow_localhost: true
)
